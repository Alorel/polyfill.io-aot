...
because of the `node-zopfli` dependency. `--ignore-engines` *may* be necessary as `polyfill-service`
...
| zopfli         	| `{blocksplitting: true, numiterations: 15}` 	| Options to pass to [node-zopfli](https://github.com/pierreinglebert/node-zopfli/tree/6adf6906ff8acbb52659b77e5f3dd445117a2287#options)                                                                                                                |
...
## CLI
    ...
    Inline config:
      ...
      --zopfli, -z     Options to pass to node-zopfli (JSON5).                                                                              [string] [default: {blocksplitting: true, numiterations: 15}]
