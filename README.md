...
[![Build Status](https://travis-ci.com/Alorel/polyfill.io-aot.svg?branch=4.0.5)](https://travis-ci.com/Alorel/polyfill.io-aot)
...
[![Coverage Status](https://coveralls.io/repos/github/Alorel/polyfill.io-aot/badge.svg?branch=4.0.5)](https://coveralls.io/github/Alorel/polyfill.io-aot?branch=4.0.5)
...
- Node >=11.7.0
- [polyfill-library](https://www.npmjs.com/package/polyfill-library)
...
|----------------	|---------------------------------------------	|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------	|
| brotli         	| `{[zlib.constants.BROTLI_PARAM_QUALITY]: 11}` | Options to pass to the Brotli encoder                                                                                                                                                                                                                                                   |
...
## CLI
    ...
    Inline config:
      --brotli, -b     Options to pass to the Brotli compressor (JSON5).                                                                                                    [string] [default: {quality: 11}]
